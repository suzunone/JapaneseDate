...
class SeventyTwoKouCalculator
{
     ...
     * 立春初候が 1、大寒末候が 72 です。
     *
     * @param DateTime|DateTimeImmutable $date 対象日付
     ...
     *
     * @param int $solarTermConst 節気定数（{@see DateTime::SOLAR_TERM_RISSYUN} 等）
     * @param int $year 西暦年
     ...
     *
     * @param DateTime|DateTimeImmutable $date 基準日付（年の特定に使用）
