 ...
 * {@link \Carbon\CarbonImmutable} 継承の不変（イミュータブル）日時クラスです。
 *
 * @category    DateTime
 ...
 *
 * 日時操作ライブラリ {@link CarbonImmutable} を継承しており、CarbonImmutable および PHP 標準
 * {@link \DateTimeImmutable} が持つすべてのメソッド・プロパティをそのまま利用できます。
 ...
 * ```
 *
 * **可変版が必要な場合は {@see DateTime} を使用してください。**
 *
 * **主な拡張機能:**
 *
 * 1. **国民の祝日・休日判定**
