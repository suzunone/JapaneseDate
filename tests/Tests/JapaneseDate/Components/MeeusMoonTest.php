...
class MeeusMoonTest extends TestCase
{
    ...
    public function test_TABLE_47A_sha256_matches_canonical(): void
    {
        $this->assertSame(
            ...
            hash('sha256', json_encode(MeeusMoon::TABLE_47A, JSON_THROW_ON_ERROR))
        );
    }
    ...
    public function test_TABLE_47B_sha256_matches_canonical(): void
    {
        $this->assertSame(
            ...
            hash('sha256', json_encode(MeeusMoon::TABLE_47B, JSON_THROW_ON_ERROR))
        );
    }
    ...
    public function test_factory_longitudeMoon_matches_direct_MeeusMoon(): void
    {
        foreach ([
            ...
            try {
                ...
                $direct = (new Astronomy(null, new MeeusMoon(applyNasaCCorrection: $applyC)))
