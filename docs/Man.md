...
echo JapaneseDateTime::parse(time());    // Throw Exception DateTime::__construct(): Failed to parse time string (1526707454) at position 8 (5): Unexpected character
...
``` .php
echo JapaneseDateTime::factory(time());    // 2018-05-19 14:24:15

echo JapaneseDateTime::factory(new DateTime('now'));    // 2018-05-19 14:24:15
