...
echo JapaneseDateTime::parse(time());    // Throw Exception DateTime::__construct(): Failed to parse time string (1526120564) at position 8 (6): Unexpected character
...
``` .php
echo JapaneseDateTime::factory(time());    // 2018-05-12 19:22:44

echo JapaneseDateTime::factory(new DateTime('now'));    // 2018-05-12 19:22:44
