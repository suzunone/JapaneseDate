...
echo JapaneseDateTime::parse(time());    // Throw Exception DateTime::__construct(): Failed to parse time string (1526702520) at position 8 (2): Unexpected character
...
``` .php
echo JapaneseDateTime::factory(time());    // 2018-05-19 13:02:00

echo JapaneseDateTime::factory(new DateTime('now'));    // 2018-05-19 13:02:00
