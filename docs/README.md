...
echo JapaneseDateTime::parse(time());    // 2026-05-28 17:52:58
...
``` .php
echo JapaneseDateTime::factory(time());    // 2026-05-28 17:52:58

echo JapaneseDateTime::factory(new DateTime('now'));    // 2026-05-29 02:52:58
