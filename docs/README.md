...
echo JapaneseDateTime::parse(time());    // 2026-05-28 23:38:59
...
``` .php
echo JapaneseDateTime::factory(time());    // 2026-05-28 23:38:59

echo JapaneseDateTime::factory(new DateTime('now'));    // 2026-05-29 08:38:59
