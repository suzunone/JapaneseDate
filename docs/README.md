...
echo JapaneseDateTime::parse(time());    // 2026-06-06 07:02:04
...
``` .php
echo JapaneseDateTime::factory(time());    // 2026-06-06 07:02:04

echo JapaneseDateTime::factory(new DateTime('now'));    // 2026-06-06 16:02:04
