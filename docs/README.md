...
echo JapaneseDateTime::parse(time());    // 2026-06-06 07:03:26
...
``` .php
echo JapaneseDateTime::factory(time());    // 2026-06-06 07:03:26

echo JapaneseDateTime::factory(new DateTime('now'));    // 2026-06-06 16:03:26
