...
echo JapaneseDateTime::parse(time());    // 2026-05-28 14:13:21
...
``` .php
echo JapaneseDateTime::factory(time());    // 2026-05-28 14:13:21

echo JapaneseDateTime::factory(new DateTime('now'));    // 2026-05-28 23:13:21
...
echo $now;                               // 2026-05-28 23:13:21
$today = JapaneseDateTime::today();
echo $today;                             // 2026-05-28 00:00:00
$tomorrow = JapaneseDateTime::tomorrow('Europe/London');
echo $tomorrow;                          // 2026-05-29 00:00:00
$yesterday = JapaneseDateTime::yesterday();
echo $yesterday;                         // 2026-05-27 00:00:00
```
