...
echo JapaneseDateTime::parse(time());    // 2026-05-29 13:31:48
...
``` .php
echo JapaneseDateTime::factory(time());    // 2026-05-29 13:31:48

echo JapaneseDateTime::factory(new DateTime('now'));    // 2026-05-29 22:31:48
