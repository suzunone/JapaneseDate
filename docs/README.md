...
echo JapaneseDateTime::parse(time());    // 2026-06-01 10:04:03
...
``` .php
echo JapaneseDateTime::factory(time());    // 2026-06-01 10:04:03

echo JapaneseDateTime::factory(new DateTime('now'));    // 2026-06-01 19:04:03
