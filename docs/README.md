...
echo JapaneseDateTime::parse(time());    // 2026-05-28 17:00:43
...
``` .php
echo JapaneseDateTime::factory(time());    // 2026-05-28 17:00:43

echo JapaneseDateTime::factory(new DateTime('now'));    // 2026-05-29 02:00:43
